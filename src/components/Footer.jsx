...
export default function Footer() {
  return (
    <footer className="border-t border-bordersubtle py-8 px-6">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-2 font-mono text-sm">
          <span className="w-1.5 h-1.5 rounded-full bg-accent" />
          <span className="tracking-wider">ALTIZOU</span>
        </div>

        <div className="font-mono text-xs text-textmuted text-center">
        ...
        <div className="flex items-center gap-4 text-textsecondary">
          <a href="https://github.com/Altizou" target="_blank" rel="noopener noreferrer" className="hover:text-accent transition">
            <GithubIcon />
          </a>
          <a href="https://www.linkedin.com/in/ramanantsirahonanaaltizou" target="_blank" rel="noopener noreferrer" className="hover:text-accent transition">
            <LinkedinIcon />
          </a>
        </div>
      </div>
