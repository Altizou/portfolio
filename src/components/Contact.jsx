  ...
  return (
    <section id="contact" className="py-24 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-bgcard border border-bordersubtle rounded-lg p-8 mb-6">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-bgprimary border border-bordersubtle rounded px-4 py-3 text-sm transition-colors duration-300 focus:outline-none focus:border-accent"
                />
              </div>
              <div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-bgprimary border border-bordersubtle rounded px-4 py-3 text-sm transition-colors duration-300 focus:outline-none focus:border-accent resize-none"
              />
            </div>
            ...
            <button
              ...
              className="bg-accent text-bgprimary font-semibold px-6 py-3 rounded transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_0_20px_rgba(34,211,238,0.4)] disabled:opacity-50 disabled:hover:scale-100"
            >
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <a href="https://github.com/Altizou" target="_blank" rel="noopener noreferrer" className="group bg-bgcard border border-bordersubtle rounded-lg p-6 flex items-center gap-4 transition-all duration-300 hover:-translate-y-1 hover:border-accent hover:shadow-[0_10px_30px_rgba(34,211,238,0.15)]">
            <div className="w-10 h-10 rounded bg-bgprimary border border-bordersubtle flex items-center justify-center text-accent transition-transform duration-300 group-hover:scale-110 group-hover:rotate-6">
              <GithubIcon />
            </div>
            <div>
          ...
          <a href="https://www.linkedin.com/in/ramanantsirahonanaaltizou" target="_blank" rel="noopener noreferrer" className="group bg-bgcard border border-bordersubtle rounded-lg p-6 flex items-center gap-4 transition-all duration-300 hover:-translate-y-1 hover:border-accent hover:shadow-[0_10px_30px_rgba(34,211,238,0.15)]">
            <div className="w-10 h-10 rounded bg-bgprimary border border-bordersubtle flex items-center justify-center text-accent transition-transform duration-300 group-hover:scale-110 group-hover:rotate-6">
              <LinkedinIcon />
            </div>
            <div>
          ...
          <a href="mailto:ramanantsirahonana2@gmail.com" className="group bg-bgcard border border-bordersubtle rounded-lg p-6 flex items-center gap-4 transition-all duration-300 hover:-translate-y-1 hover:border-accent hover:shadow-[0_10px_30px_rgba(34,211,238,0.15)]">
            <div className="w-10 h-10 rounded bg-bgprimary border border-bordersubtle flex items-center justify-center text-accent transition-transform duration-300 group-hover:scale-110 group-hover:rotate-6">
              <Mail size={20} />
            </div>
            <div>
